          ...
          setState(() {
            ...
            Positioned(
             ...
             right: 16,
                     ...
                     Padding(
                      ...
                      onPressed:() async{
                        ...
                        // Chuyển đổi tên địa điểm thành tọa độ
                         List<Location> originLocations = await locationFromAddress(origin);
                ...
                PointLatLng(destinationLocation.latitude, destinationLocation.longitude), // Tọa độ điểm đến
                travelMode: TravelMode.driving, // Hoặc sử dụng travelMode tùy chọn
                );

                if (result.points.isNotEmpty) {
                  List<LatLng> routeCoords = result.points.map((point) => LatLng(point.latitude, point.longitude)).toList();
                  ...
                  CameraUpdate cameraUpdate = CameraUpdate.newLatLngBounds(bounds, 100); // 50 là padding cho phần biên
                  ...
                  String distanceNumber = distance.replaceAll(RegExp(r'[^0-9.]'), '');

                  double? distanceTest = double.tryParse(distanceNumber);
                  if (distanceTest != null) {
                  //Lỗi giá
                  price = await getPrice(distanceTest);
                  }
